...
import { getEventColor, getEventsForDay } from "../../utils/event.utils";
          ...
          {timeSlots.map((time, hourIndex) => (
            <div key={time} className="contents">
              ...
              {weekDays.map((day) => {
                const isFocused =
                  focusedDate &&
                  focusedHour === hourIndex &&
                  formatDate(day, "yyyy-MM-dd") ===
                    formatDate(focusedDate, "yyyy-MM-dd");
                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      isFocused &&
                        "ring-2 ring-[hsl(var(--calendar-focus-ring))] ring-inset"
                    )}
